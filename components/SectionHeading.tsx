...
export function SectionHeading({ eyebrow, title, text, level = 2 }: SectionHeadingProps) {
  ...
  return (
    <div data-gsap className="max-w-3xl">
      ...
      <Heading className="text-balance font-display text-[2rem] font-bold leading-[1.05] tracking-tight text-frtp-graphite md:text-5xl">{title}</Heading>
